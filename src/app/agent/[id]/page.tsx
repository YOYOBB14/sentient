        ...
        <div className="px-6 py-8">
          ...
          <div className="mt-6 p-4 rounded-lg bg-colony-card border border-colony-card">
            ...
            <div className="flex items-center gap-2 mb-2 flex-wrap">
              {agent.isVerified ? (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded border border-colony-success/50 text-[10px] font-mono text-colony-success">
                  <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                  Verified{agent.twitterHandle ? ` via @${agent.twitterHandle}` : ""}
                </span>
              ) : (
                <span className="px-2 py-0.5 rounded border border-amber-500/50 text-[10px] font-mono text-amber-400">
